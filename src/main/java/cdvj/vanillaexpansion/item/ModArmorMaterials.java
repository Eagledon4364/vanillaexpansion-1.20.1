...
public enum ModArmorMaterials implements ArmorMaterial {
    PYRONITE("pyronite", 40, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
    ...
    ModArmorMaterials(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionAmounts,
                      int enchantibility, SoundEvent equipSound, float toughness,
    ...
    public String getName() {
        return VanillaExpansion.MOD_ID + ":" + this.name;
    }
